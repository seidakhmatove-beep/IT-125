...
def main():
    ...
    print("Вы просыпаетесь в холодной каменной комнате.")
    ...
    while play_again:
        ...
        if door_unlocked:
            ...
            print(f"[ПОДСКАЗКА] Секретный код: {secret_code}")
            ...
            while attempts > 0:
                try:
                    ...
                    if guess < 100 or guess > 999:
                        print("Код должен быть трёхзначным числом (от 100 до 999)!")
                        continue
            ...
            if choice3 == "вверх":
                ...
                if choice4 == "да":
                    ...
                    print("Вы мудро решили не есть незнакомые грибы.")
                ...
                print("Не понимаю ваш выбор. Вы стоите на месте и вас находит стража.")
                print("ИГРА ОКОНЧЕНА")
